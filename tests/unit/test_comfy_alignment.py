...
class TestComfyAlignment(unittest.TestCase):
    def test_registry_has_builtin_components(self):
        ...
        self.assertIn("flux", list_adapters())
        self.assertIn("flux2", list_adapters())
        self.assertIn("ltxv", list_adapters())
        self.assertIn("ideogram4", list_adapters())
    ...
    def test_comfyui_contract_index_is_static_artifact_metadata(self):
        ...
        self.assertIn("flux", contracts["contracts"])
        self.assertIn("flux2", contracts["contracts"])
        self.assertIn("ltxv", contracts["contracts"])
        self.assertIn("ideogram4", contracts["contracts"])
        self.assertEqual(contracts["contracts"]["ideogram4"]["export_name"], "Ideogram-4")
